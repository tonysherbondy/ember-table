...
App.TreeTableExample.ColumnGroups = Ember.ArrayController.extend
  columns: null
...
App.TreeTableExample.TreeDataAdapter = Ember.Mixin.create
  ...
  columnGroups: Ember.computed ->
    columns = @get('columns')
    stocks  = App.TreeTableExample.ColumnGroups.create
      headerCellName: 'Stocks'
      headerCellViewClass: 'App.TreeTableExample.HeaderColspanCell'
      columns: columns.slice(1, 4)
    bonds   = App.TreeTableExample.ColumnGroups.create
  ...
  columns: Ember.computed ->
    ...
    columns = names.map (name, index) ->
      Ember.Table.ColumnDefinition.create
        index: index
        headerCellName: name
        headerCellViewClass: 'App.TreeTableExample.HeaderCell'
        getCellContent: (row) ->
...
# Views
################################################################################
App.TreeTableExample.HeaderColspanCell = Ember.Table.HeaderCell.extend
